 ...
 */
  ...
  * version of the GL library.  _GLFW_BUILD_DLL is defined by the GL
 ...
 */
 ...
 /* We are building GL as a Win32 DLL */
 #define GLFWAPI __declspec(dllexport)
#elif defined(_WIN32) && defined(GLFW_DLL)
 /* We are calling GL as a Win32 DLL */
 #define GLFWAPI __declspec(dllimport)
#elif defined(__GNUC__) && defined(_GLFW_BUILD_DLL)
 /* We are building GL as a shared / dynamic library */
 #define GLFWAPI __attribute__((visibility("default")))
#else
 /* We are building or calling GL as a static library */
 #define GLFWAPI
#endif
 ...
 *  physical device supports presentation to the platform GL was built for.
 *
 ...
 *  It is the responsibility of the caller to destroy the window surface.  GL
 ...
 *  GLFW_API_UNAVAILABLE and @ref GLFW_PLATFORM_ERROR.
 *
 *  @remarks If an error occurs before the creation call is made, GL returns
